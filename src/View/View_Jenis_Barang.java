 ...
 * @author MRafliF
 */
public class View_Jenis_Barang extends javax.swing.JFrame {

    private Controller controller;
    
    public View_Jenis_Barang() throws SQLException {
        initComponents();
    ...
    public void showtblJenisBarang() throws SQLException {
        ...
        for(Jenis_Barang jb : controller.getDataJenisBarang()) {
            dtmJenisBarang.addRow(new String[]{jb.getId_Jenis_Barang().toString(), jb.getNama_Jenis_Barang().toString()});
        }
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        try {
            ...
            jb.setNama_Jenis_Barang(tfJenisBarang.getText());
            controller.insertJenisBarang(jb);
            showtblJenisBarang();
            tfJenisBarang.setText("");
        } catch (SQLException ex) {
            Logger.getLogger(View_Jenis_Barang.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Jenis_Barang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
